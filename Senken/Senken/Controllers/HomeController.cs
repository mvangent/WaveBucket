...
namespace Senken.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            ViewBag.Message =
                "WaveBucket is a chatbox for sound waves. Grounded in modular, additive synthesizing, it offers a communal space for sound design and electronic music experiments. Realtime tweaking a synthesizer with your friends in seperate locations is" +
